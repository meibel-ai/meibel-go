...
// AddGatewayDatasourceRequest represents the AddGatewayDatasourceRequest type.
type AddGatewayDatasourceRequest struct {
	Name string `json:"name"`
...
type AddRagConfigRequest struct {
	...
	MetadataModel interface{} `json:"metadata_model,omitempty"`
}
...
type GetReprocessStatusResponse struct {
...
type PatchRagConfigMetadataRequest struct {
	MetadataModel MetadataModelConfig `json:"metadata_model"`
}

// PatchRagConfigMetadataResponse PatchRagConfigMetadataResponse
type PatchRagConfigMetadataResponse struct {
	Message string `json:"message"`
}
...
type PutDataElementMetadataRequest struct {
	Metadata string `json:"metadata"`
}

// PutDataElementMetadataResponse PutDataElementMetadataResponse
type PutDataElementMetadataResponse struct {
...
type ReprocessDatasourceRequest struct {
	MetadataModel interface{} `json:"metadata_model,omitempty"`
}

// ReprocessDatasourceResponse ReprocessDatasourceResponse
type ReprocessDatasourceResponse struct {
	WorkflowId string `json:"workflow_id"`
}
...
// DatasourceServiceClientModelsUpdateDataElementRequestUpdateDataElementRequest UpdateDataElementRequest
type DatasourceServiceClientModelsUpdateDataElementRequestUpdateDataElementRequest struct {
	Description interface{} `json:"description,omitempty"`
	Name interface{} `json:"name,omitempty"`
...
// DatasourceServiceClientModelsUpdateDatasourceRequestUpdateDatasourceRequest UpdateDatasourceRequest
type DatasourceServiceClientModelsUpdateDatasourceRequestUpdateDatasourceRequest struct {
	Name interface{} `json:"name,omitempty"`
	Description interface{} `json:"description,omitempty"`
...
// DatasourceServiceClientModelsWebDomainWebDomain WebDomain
type DatasourceServiceClientModelsWebDomainWebDomain struct {
...
// GatewayServiceV2ModelsDataElementsUpdateDataElementRequest represents the gateway_service__v2__models__data_elements__UpdateDataElementRequest type.
type GatewayServiceV2ModelsDataElementsUpdateDataElementRequest struct {
	Name interface{} `json:"name,omitempty"`
	Metadata interface{} `json:"metadata,omitempty"`
}

// GatewayServiceV2ModelsDatasourcesUpdateDatasourceRequest represents the gateway_service__v2__models__datasources__UpdateDatasourceRequest type.
type GatewayServiceV2ModelsDatasourcesUpdateDatasourceRequest struct {
	Name interface{} `json:"name,omitempty"`
	Description interface{} `json:"description,omitempty"`
	Connector interface{} `json:"connector,omitempty"`
}

// GatewayServiceV2ModelsDatasourcesWebDomain represents the gateway_service__v2__models__datasources__WebDomain type.
type GatewayServiceV2ModelsDatasourcesWebDomain struct {
	Domain string `json:"domain"`
