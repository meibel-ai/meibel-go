...
// DatasourcesContentService handles datasources.content operations.
type DatasourcesContentService struct {
...
func (s *DatasourcesContentService) ListDatasourceContent(ctx context.Context, datasourceId string, opts *ListDatasourceContentOptions) *PageIterator[ContentItem] {
...
func (s *DatasourcesContentService) UploadDatasourceContent(ctx context.Context, datasourceId string) (*UploadContentResponse, error) {
	path := "/datasource/" + fmt.Sprintf("%v", datasourceId) + "/content"
...
func (s *DatasourcesContentService) StreamUploadProgress(ctx context.Context, uploadId string) error {
...
func (s *DatasourcesContentService) GetDatasourceUploadStatus(ctx context.Context, datasourceId string, uploadId string) (*string, error) {
...
func (s *DatasourcesContentService) StreamDatasourceUploadProgress(ctx context.Context, datasourceId string, uploadId string) error {
...
func (s *DatasourcesContentService) GetDatasourceContentMetadata(ctx context.Context, datasourceId string, path string) (*GetContentResponse, error) {
...
func (s *DatasourcesContentService) DeleteDatasourceContent(ctx context.Context, datasourceId string, path string) (*DeleteContentResponse, error) {
	reqPath := "/datasource/" + fmt.Sprintf("%v", datasourceId) + "/content/" + fmt.Sprintf("%v", path)
...
func (s *DatasourcesContentService) DownloadDatasourceContent(ctx context.Context, datasourceId string, path string) error {
...
func (s *DatasourcesContentService) TriggerIngest(ctx context.Context, datasourceId string) (*string, error) {
